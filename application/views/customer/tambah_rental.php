<div class="container">
    <div class="card" style="margin-top:200px;margin-bottom:180px;">
        <div class="card-header">
            Form Rental Mobil
        </div>
        <div class="card-body">
            <?php foreach($detail as $dt):?>
                <form method="post" action="<?php echo base_url('rental/tambah_rental_aksi')?>">
                    <div class="form-group">
                        <label>Harga Sewa/Hari</label>
                        <input type="hidden" name="id_mobil" class="form-control" value="<?php echo $dt->id_mobil;?>">
